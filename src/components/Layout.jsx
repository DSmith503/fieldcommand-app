...
import { LayoutDashboard, FolderKanban, Calendar, Clock, FileText, MessageSquare, Users, UserCog, Sparkles, Activity, LogOut, Menu, X, Zap, Wrench, Receipt, Phone } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      <aside className="hidden lg:flex flex-col w-56 bg-white/[0.02] border-r border-white/[0.04] fixed inset-y-0 left-0 z-40 backdrop-blur-xl">
        <div className="p-5 flex items-center gap-3">
          <img src={ELITE_LOGO} alt="Elite" className="h-8 object-contain" onError={e => { e.target.style.display='none'; }} />
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-zinc-950/90 backdrop-blur-md border-b border-white/[0.04] h-14 flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2"><img src={ELITE_LOGO} alt="" className="h-6" onError={e => e.target.style.display='none'} /><span className="font-bold text-sm">FieldCommand</span></div>
      </div>
